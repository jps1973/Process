...
#define RUNNING_LIST_VIEW_WINDOW_COLUMN_TITLES									{ "Name", "ID", "Details" }
...
#define RUNNING_LIST_VIEW_WINDOW_UNABLE_TO_ENUMERATE_PROCESSES_ERROR_MESSAGE	"Unable to enumerate processes"
